...
const FBScan = () => {
  ...
  const handleProceedToDeepScan = async () => {
    ...
    try {
      ...
      addAIThought("thinking", "📘 Facebook AI Engine: Initializing full video scan...");
      ...
      if (result.violations && result.violations.length > 0) {
        ...
        const violations: ViolationComparison[] = result.violations.map((violation, index) => ({
          ...
          policyReference: `Facebook Community Standards - Policy Section`,
      ...
      addAIThought("success", "✅ Facebook Deep Scan Complete! Report saved.");
